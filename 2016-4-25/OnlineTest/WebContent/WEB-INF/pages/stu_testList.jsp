				...
				<div class="page-header">
					<div class="pull-left">
						<ol class="breadcrumb visible-sm visible-md visible-lg">
							...
							<li><a><i class="fa fa-file-text"></i>考试信息</a></li>
						</ol>
					</div>
...
<!-- 												<th width="">旷考</th> -->
								...
								<div class="btn-toolbar" role="toolbar">
									...
									<div class="bk-margin-5 btn-group" style="float: right; right: -5px;">
										<button type="button" class="btn btn-default" onclick="stuTestFirst()">首页</button>
										<button type="button" class="btn btn-default" onclick="stuTestPrev()">上一页</button>
										<button type="button" class="btn btn-default" onclick="stuTestNext()">下一页</button>
										<button type="button" class="btn btn-default" onclick="stuTestLast()">尾页</button>
									</div>
								</div>
							</div>
						</div>
	...
	<script type="text/javascript" src="<%=path%>/js/stu_testlist.js"></script>
	<!-- end: JavaScript-->
</body>
</html>