...
<!-- img css -->
<link href="<%=path%>/css/magnific-popup.css" rel="stylesheet"/>
<!-- Theme CSS -->
...
<body>
				...
				<div class="page-header">
					<div class="pull-left">
						<ol class="breadcrumb visible-sm visible-md visible-lg">
							...
							<li class="active"><i class="fa fa-th-list"></i>教师管理</li>
						</ol>
					</div>
					...
					<div class="col-lg-12">
						<div class="panel" style="min-width: 910px;">
							<div class="panel-heading" style="background-color: #34495E">
								<h6>
									<i class="fa fa-table red"></i><span class="break" id="CMtitle" style="font-size: 16px; color: #eee">教师列表</span>
								</h6>
							...
							<div class="panel-body">
								...
								<div class="btn-toolbar" id="CMbuttonGroup" role="toolbar">
									...
									<div class="bk-margin-5 btn-group" style="float: right; right: -5px;">
										<button type="button" class="btn btn-default" onclick="teacherListFirst()">首页</button>
										<button type="button" class="btn btn-default" onclick="teacherListPrev()">上一页</button>
										<button type="button" class="btn btn-default" onclick="teacherListNext()">下一页</button>
										<button type="button" class="btn btn-default" onclick="teacherListLast()">尾页</button>
									</div>
								</div>
							</div>
						</div>
	...
	<script type="text/javascript" src="<%=path%>/js/teacherlist.js"></script>
