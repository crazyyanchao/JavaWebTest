...
<body>
				...
				<div class="page-header">
					<div class="pull-left">
						<ol class="breadcrumb visible-sm visible-md visible-lg">
							...
							<li class="active"><i class="fa fa-adjust"></i>填空判断题</li>
						</ol>
					</div>
						...
						<div class="panel" style="min-width: 910px;">
							<div class="panel-heading" style="background-color: #34495E">
								...
								<div class="panel-actions">
									<a href="javascript:void();" onclick="fillBlankReload()" class="btn-setting"><i class="fa fa-rotate-right"></i></a>
								</div>
							</div>
							<div class="panel-body">
								<div class="table-responsive">
									<div style="text-align: center;">
										<label class="search_condiction">科目</label><input id="fillblank_course" onclick="courseSelectPanel_search()" class="form-control" style="display:inline-block; width:150px;margin: 0 20px 0 10px">
								...
								<div class="btn-toolbar" role="toolbar">
									...
									<div class="bk-margin-5 btn-group" style="float: right; right: -5px;">
										<button type="button" class="btn btn-default" onclick="fillBlankFirst()">首页</button>
										<button type="button" class="btn btn-default" onclick="fillBlankPrev()">上一页</button>
										<button type="button" class="btn btn-default" onclick="fillBlankNext()">下一页</button>
										<button type="button" class="btn btn-default" onclick="fillBlankLast()">尾页</button>
									</div>
								</div>
							</div>
						</div>
	...
	<script type="text/javascript" src="<%=path%>/js/fillblank.js"></script>
	<!-- end: JavaScript-->
</body>
</html>