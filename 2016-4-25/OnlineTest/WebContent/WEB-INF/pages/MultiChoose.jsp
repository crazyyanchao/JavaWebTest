...
<body>
				...
				<div class="page-header">
					<div class="pull-left">
						<ol class="breadcrumb visible-sm visible-md visible-lg">
							...
							<li class="active"><i class="fa fa-plus"></i>多选题</li>
						</ol>
					</div>
						...
						<div class="panel" style="min-width: 910px;">
							<div class="panel-heading" style="background-color: #34495E">
								...
								<div class="panel-actions">
									<a href="javascript:void();" onclick="multiChooseReload()" class="btn-setting"><i class="fa fa-rotate-right"></i></a>
								</div>
							</div>
							<div class="panel-body">
								<div class="table-responsive">
									<div style="text-align: center;">
										<label class="search_condiction">科目</label><input id="multichoose_course" onclick="courseSelectPanel_search()" class="form-control" style="display:inline-block; width:150px;margin: 0 20px 0 10px">
								...
								<div class="btn-toolbar" role="toolbar">
									...
									<div class="bk-margin-5 btn-group" style="float: right; right: -5px;">
										<button type="button" class="btn btn-default" onclick="multiChooseFirst()">首页</button>
										<button type="button" class="btn btn-default" onclick="multiChoosePrev()">上一页</button>
										<button type="button" class="btn btn-default" onclick="multiChooseNext()">下一页</button>
										<button type="button" class="btn btn-default" onclick="multiChooseLast()">尾页</button>
									</div>
								</div>
							</div>
						</div>
	...
	<script type="text/javascript" src="<%=path%>/js/multichoose.js"></script>
	<!-- end: JavaScript-->
</body>
</html>