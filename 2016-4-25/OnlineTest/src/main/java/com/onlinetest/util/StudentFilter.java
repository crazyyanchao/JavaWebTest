...
public class StudentFilter implements Filter {
	private static Logger log = Logger.getLogger(StudentFilter.class);
	...
	public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain)
		...
		if(session.getAttribute("role") == null){
			...
			if( !session.getAttribute("role").equals("学生") ){	
...
//				}
				...
				log.info("StudentFilter: the user("+session.getAttribute("userId")+") is not student ,access denied!");
			}
		}
