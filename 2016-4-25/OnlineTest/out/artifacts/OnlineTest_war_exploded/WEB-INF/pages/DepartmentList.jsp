...
<body>
				...
				<div class="page-header">
					<div class="pull-left">
						<ol class="breadcrumb visible-sm visible-md visible-lg">
							...
							<li><a href="javascript:void();"><i class="glyphicon glyphicon-list"></i>科系管理</a></li>
						</ol>
					</div>
					...
					<div class="col-lg-12">
						<div class="panel" style="min-width: 910px;">
							<div class="panel-heading" style="background-color: #34495E">
								<h6>
									<i class="fa fa-table red"></i><span class="break" style="font-size: 16px; color: #eee">科系列表</span>
								</h6>
							...
							<div class="panel-body">
								<div class="table-responsive">
									<div style="float: right;height: 50px;">
										<label class="search_condiction">学院</label><select id="departmentlist_depart" class="form-control" style="width: 100px;display: inline-block;margin: 0 20px 0 10px"><option value="">所有学院</option></select> 
										<button class="btn btn-default" onclick="search_depart(this)" style="margin-right: 80px">确定</button>
									</div>
	...
	<script type="text/javascript" src="<%=path%>/js/departmentlist.js"></script>
	<!-- end: JavaScript-->
</body>
</html>